    ...
    if (!previewOnly) {
      ...
      if (preview) {
        const message = originals.length
          ...
          : "Для PNG нет прямой ссылки на исходник. Скачать PNG из превью с ограниченным качеством? Оригинал в Drive, если подключён, можно скачать отдельно из медиатеки.";
