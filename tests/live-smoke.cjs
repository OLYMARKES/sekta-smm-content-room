...
async function main() {
  const files = ["index.html", "app.js", "carousel-builder.js", "media-source.js", "media-overrides.js", "workspace-safety.js", "workspace-backup.js", "styles.css", "type-studio/carousel-type-lab.html", "type-studio/carousel-type-lab.js", "type-studio/embedded.js", "assets/brand/sekta-logo-round.png"];
  const verified = [];
